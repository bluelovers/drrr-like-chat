	...
	<div data-role="page" id="page_about" data-theme="c">
		...
		<div data-role="content">
			...
			<div class="header">
				<div class="content">
					<h2 class="tanaka"><img src="<?php echo DURA_URL;?>/static/style/icon/tanaka.png" />アニメ『デュラララ!!』に登場するチャットを再現！</h2>
					...
					<h2 class="kanra"><img src="<?php echo DURA_URL;?>/static/style/icon/kanra.png" />誰でも参加することができます！</h2>
					...
					<h2 class="zawa"><img src="<?php echo DURA_URL;?>/static/style/icon/zawa.png" />参加は名前を決めてログインするだけ！</h2>
					...
					<h2 class="gg"><img src="<?php echo DURA_URL;?>/static/style/icon/gg.png" />ゆっくり楽しんでいってね</h2>
