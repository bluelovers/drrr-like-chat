		...
		<div data-role="content">
			...
			<div class="main-box content-primary" id="talks">
				...
				<?php foreach ( $dura['room']['talks'] as $talk ) : ?>
					...
					<?php else: ?>
						<dl class="talk icon_<?php e($talk['icon']) ?> <?php if ( $talk['uid'] == $dura['room']['host'] ) :?> dura-ishost <?php endif; ?>" id="<?php e($talk['id']) ?>" <?php e($talk['time'] <= $dura['input']['last_talk_time'] ? ' dura-show="1"' : ''); ?> >
