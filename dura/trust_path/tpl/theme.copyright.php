			...
			<div class="copyright" data-theme="a" data-role="fieldcontain">
				...
				<p>
					<img src="http://chart.apis.google.com/chart?cht=qr&chs=120x120&chl=<?php e(urlencode($this->get('tpl.header.canonical', DURA_URL))); ?>&chld=H|0" alt="<?php e($this->get('html.title', t(DURA_TITLE).' | '.t(DURA_SUBTITLE))) ?>"/>
				</p>
